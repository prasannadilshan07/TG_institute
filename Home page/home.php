    ...
    <section class="tutors-section" id="tutors">
      ...
      <div class="tutors-container">
        ...
        <a href="/TopGrade/Tutor Main page/Tutor prasanna/prasanna.php">
          <div class="tutor">
            <img src="prasanna.jpg" alt="Tutor 1">
            <div class="tutor-overly">
              <p><strong>Dr. Prasanna</strong></p>
            </div>
          </div>
        </a>

        <!-- Tutor 2 -->
        <a href="/TopGrade/Tutor Main page/Tutor dewmi/dewmi.php">
          <div class="tutor">
            <img src="dewmi.jpg" alt="Tutor 2">
            <div class="tutor-overly">
              <p><strong>Miss. Dewmi </strong></p>
            </div>
          </div>
        </a>
        ...
        <!-- Tutor 3 -->
        <a href="/TopGrade/Tutor Main page/Tutor supun/supun.php">
          <div class="tutor">
            <img src="supun.jpg" alt="Tutor 3">
            <div class="tutor-overly">
              <p><strong>Mr.Supun</strong></p>
            </div>
          </div>
        </a>
        ...
        <!-- Tutor 4 -->
        <a href="/TopGrade/Tutor Main page/Tutor shahee/shahee.php">
          <div class="tutor">
            <img src="shaheeka.jpg" alt="Tutor 3">
            <div class="tutor-overly">
              <p><strong>Miss. Shaheeka</strong></p>
            </div>
          </div>
        </a>

        <!-- Tutor 5 -->
        <a href="/TopGrade/Tutor Main page/Tutor chavidu/chavidu.php">
          <div class="tutor">
            <img src="chavidu.jpg" alt="Tutor 3">
            <div class="tutor-overly">
              <p><strong>Mr. Chavidu</strong></p>
            </div>
          </div>
        </a>

        <!-- Tutor 6 -->
        <a href="/TopGrade/Tutor Main page/Tutor sanchala/sanchala.php">
          <div class="tutor">
            <img src="sanchala.jpg" alt="Tutor 3">
            <div class="tutor-overly">
              <p><strong>Miss. Sanchala</strong></p>
            </div>
          </div>
        </a>
